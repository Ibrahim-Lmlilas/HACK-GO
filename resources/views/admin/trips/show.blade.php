                ...
                <div class="p-4">
                    <div class="mb-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2">
                            ...
                            <form action="{{ route('admin.trips.destroy', $trip) }}" method="POST" class="flex-1">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                                        class="w-full bg-red-500 text-white px-3 py-2 rounded text-sm hover:bg-red-600 transition-all"
