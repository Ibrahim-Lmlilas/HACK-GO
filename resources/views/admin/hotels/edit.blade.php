...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-indigo-800">Edit Hotel: {{ $hotel->name }}</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        required placeholder="Enter hotel name" value="{{ old('name', $hotel->name) }}">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="location" id="location"
                        class="w-full py-3 px-4 rounded-md border-indigo-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                        required placeholder="City, Country" value="{{ old('location', $hotel->location) }}">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price_per_night" id="price_per_night" step="0.01" min="0"
                        class="w-full py-3 px-4 rounded-md border-indigo-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                        required placeholder="0.00" value="{{ old('price_per_night', $hotel->price_per_night) }}">
                </div>
            ...
            <div class="mt-6">
                ...
                @if($hotel->image)
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/' . $hotel->image) }}" alt="{{ $hotel->name }}" class="h-40 w-auto object-cover rounded-md shadow-sm">
                    </div>
                @endif
