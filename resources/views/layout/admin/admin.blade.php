                        ...
                        <div id="notificationsDropdown" class="hidden absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg z-50">
                            <div class="p-4">
                                ...
                                <div class="max-h-96 overflow-y-auto">
                                    @forelse(Auth::user()->adminNotifications()->latest()->take(5)->get() as $notification)
                                ...
                                @if(Auth::user()->adminNotifications()->count() > 5)
                                    <a href="{{ route('notifications.admin') }}" class="block text-center text-sm text-blue-500 mt-2">View all notifications</a>
                                @endif
                            </div>
                        </div>
                    </div>
