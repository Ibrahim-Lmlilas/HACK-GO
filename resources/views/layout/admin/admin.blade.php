    ...
    <div class="flex h-screen bg-gray-50">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white shadow-sm transition-transform duration-300 transform -translate-x-full lg:translate-x-0 z-30 lg:relative lg:flex lg:flex-col border-r  lg:shadow-none">
            ...
            <nav class="flex-1 px-4 mt-6 space-y-2 overflow-y-auto border-t">
                ...
                <!-- Destinations -->
                <a href="{{ route('admin.destinations.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-900 rounded-lg hover:bg-gray-100 transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Hotels -->
                <a href="{{ route('admin.hotels.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-900 rounded-lg hover:bg-gray-100 transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Transport -->
                <a href="{{ route('admin.transports.index') }}" class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-900 rounded-lg hover:bg-gray-100 transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
