...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-[#FEFBEA]">
        ...
        <div class="relative min-h-screen">
            ...
            <footer class="bg-[#000] text-white">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="md:ml-28">
                            ...
                            <div class="flex space-x-4">
                                <a href="#" class="text-gray-400 hover:text-[#92472B] transition-colors">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2 md:ml-12">
                                <a href="#" class="text-gray-400 hover:text-[#92472B] transition-colors text-sm">Blog</a>
                                <a href="#" class="text-gray-400 hover:text-[#92472B] transition-colors text-sm">About Us</a>
                                <a href="#" class="text-gray-400 hover:text-[#92472B] transition-colors text-sm">Contact</a>
                                <a href="#" class="text-gray-400 hover:text-[#92472B] transition-colors text-sm">service</a>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <p class="flex items-center text-sm text-gray-400">
                                    <svg class="w-4 h-4 text-[#92472B] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
