                ...
                <div class="container mx-auto px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="hidden md:flex items-center space-x-4">
                            ...
                            @else
                                <a href="/profile" class="flex items-center border-[#1f2937] border-2 bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg transition-colors duration-300 nav-link">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        ...
                                                        <div class="flex flex-col space-y-4">
                                                            ...
                                                            <div class="pt-4 mt-2 border-t border-gray-200">
                                                                <div class="grid grid-cols-1 gap-3 mt-3">
                                                                    ...
                                                                    @else
                                                                        <a href="/profile" class="flex items-center justify-center text-gray-800 bg-gray-100 hover:bg-gray-200 px-4 py-3 rounded-lg transition-all duration-300">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                                                            </svg>
                                                                            Dashboard
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2 md:ml-12">
                                <a href="/blog" class="text-gray-400 hover:text-blue-500 transition-colors text-sm">Blog</a>
                                <a href="/About" class="text-gray-400 hover:text-blue-500 transition-colors text-sm">About Us</a>
                                <a href="/contact" class="text-gray-400 hover:text-blue-500 transition-colors text-sm">Contact</a>
                                <a href="/" class="text-gray-400 hover:text-blue-500 transition-colors text-sm">Home</a>
                            </div>
                        </div>
